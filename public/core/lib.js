...
/**
 * addClass permet d'ajouter une classe jusqu'as IE8
 * @param {object} el        Object Element
 * @param {string} className Name de la classe
 */
Go.prototype.addClass = function (el, className) {
